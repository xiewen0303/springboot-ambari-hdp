...
public class SDKSTSUpload {
     ...
     * @param fileName
     */
    private static void testUploadVideo(String accessKeyId, String accessKeySecret,String securityToken, String title, String fileName) {
        ...
        /* 设置您实现的生成STS信息的接口实现类*/
         request.setVoDRefreshSTSTokenListener(new RefreshSTSTokenImpl(accessKeyId,accessKeySecret,securityToken));
        /* 设置应用ID*/
...
class RefreshSTSTokenImpl implements VoDRefreshSTSTokenListener {

    private String accessKeyId;
    private String accessKeySecret;
    private String securityToken;

    public RefreshSTSTokenImpl() {
    }

    public RefreshSTSTokenImpl(String accessKeyId, String accessKeySecret, String securityToken) {
    ...
    public STSTokenDTO onRefreshSTSToken() {
        ...
        stsTokenDTO.setSecurityToken(securityToken);
        return stsTokenDTO;
    }
